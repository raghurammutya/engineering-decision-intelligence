...
| --- | --- | --- | --- |
| decision_spec | Versioned decision spec contract | 14 | policy_declared_runtime_evidence_missing |
| capability_registry | Capability registry and graph contract | 10 | policy_declared_runtime_evidence_missing |
| policy_preflight | Deterministic policy preflight | 8 | policy_declared_runtime_evidence_missing |
| simulation | Simulation and decision diff evidence | 9 | policy_declared_runtime_evidence_missing |
