...
| `tools/acceptance_gates.py` | low | observe | other_scripts | no operational-state mutation capability detected<br>owner boundary is missing or unknown<br>evidence reference is present |
