...
| 0.45 | owner-map-normalization | embedded_owner_hint | owner text present without policy owner-map entry | `tools/acceptance_gates.py` | low | convert embedded owner hint into owner-map rule |
