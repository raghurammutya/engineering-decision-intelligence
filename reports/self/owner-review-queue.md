...
| owner-map-normalization | 0.45 | embedded_owner_hint | owner text present without policy owner-map entry | `tools/acceptance_gates.py` | medium | recommend | cannot claim canonical operating path | map to canonical automation or document exception |
