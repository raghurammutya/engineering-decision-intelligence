...
| --- | --- | --- | --- | --- |
| Review before autonomy expansion | 5 | P3 | missing_or_unknown | retain controlled execution with evidence |
...
| P4 | Review before autonomy expansion | `tools/acceptance_gates.py` | low | observe | missing_or_unknown | assign owner boundary |
