...
| --- | --- | --- | --- | --- |
| `.claude/commands/assess-architecture.md` | critical | config_secret_scripts | `docs/playbooks/db-migration-script.md` | block or require controlled owner review before use |
| `.claude/commands/assess-infrastructure.md` | critical | config_secret_scripts | `docs/playbooks/db-migration-script.md` | block or require controlled owner review before use |
...
| `BACKEND_FIX_PROMPTS.md` | critical | config_secret_scripts | `docs/playbooks/db-migration-script.md` | block or require controlled owner review before use |
| `BACKEND_TEAM_PROMPT_ACCOUNT_SELECTOR.md` | critical | db_migration_scripts | `docs/playbooks/db-migration-script.md` | block or require controlled owner review before use |
| `BACKEND_TEAM_PROMPT_BROKER_ACCOUNTS.md` | critical | config_secret_scripts | `docs/playbooks/db-migration-script.md` | block or require controlled owner review before use |
| `BACKEND_TEAM_PROMPT_PASSWORD_RESET_FIX.md` | critical | config_secret_scripts | `docs/playbooks/db-migration-script.md` | block or require controlled owner review before use |
| `NEXT_SESSION_PROMPT.md` | critical | config_secret_scripts | `docs/playbooks/db-migration-script.md` | block or require controlled owner review before use |
| `backend_prompt.md` | critical | config_secret_scripts | `docs/playbooks/db-migration-script.md` | block or require controlled owner review before use |
| `dev-prompt.txt` | critical | config_secret_scripts | `docs/playbooks/db-migration-script.md` | block or require controlled owner review before use |
| `docs/prompts/CLAUDE_CLI_PROMPT_GREEKS_CACHE_IMPLEMENTATION.md` | critical | db_migration_scripts | `docs/playbooks/db-migration-script.md` | block or require controlled owner review before use |
| `docs/prompts/CONFIG_SERVICE_GUIDE.md` | critical | config_secret_scripts | `docs/playbooks/db-migration-script.md` | block or require controlled owner review before use |
| `docs/prompts/CONFIG_SERVICE_IMPROVEMENTS.md` | critical | config_secret_scripts | `docs/playbooks/db-migration-script.md` | block or require controlled owner review before use |
| `docs/prompts/EXTENDED_CONFIG_SERVICE.md` | critical | config_secret_scripts | `docs/playbooks/db-migration-script.md` | block or require controlled owner review before use |
| `docs/prompts/MULTI_SERVICE_REFACTOR_BATCH_PROMPT.md` | critical | config_secret_scripts | `docs/playbooks/db-migration-script.md` | block or require controlled owner review before use |
| `docs/prompts/MY_STRATEGIES_SPRINT_PLAN.md` | critical | db_migration_scripts | `docs/playbooks/db-migration-script.md` | block or require controlled owner review before use |
| `docs/prompts/README.md` | critical | config_secret_scripts | `docs/playbooks/db-migration-script.md` | block or require controlled owner review before use |
| `docs/prompts/alert-service-context.md` | critical | config_secret_scripts | `docs/playbooks/db-migration-script.md` | block or require controlled owner review before use |
| `docs/prompts/algo-engine-context.md` | critical | config_secret_scripts | `docs/playbooks/db-migration-script.md` | block or require controlled owner review before use |
| `docs/prompts/api-gateway-context.md` | critical | config_secret_scripts | `docs/playbooks/db-migration-script.md` | block or require controlled owner review before use |
| `docs/prompts/backend-context.md` | critical | config_secret_scripts | `docs/playbooks/db-migration-script.md` | block or require controlled owner review before use |
| `docs/prompts/billing-service-context-old.md` | critical | config_secret_scripts | `docs/playbooks/db-migration-script.md` | block or require controlled owner review before use |
| `docs/prompts/billing-service-context.md` | critical | config_secret_scripts | `docs/playbooks/db-migration-script.md` | block or require controlled owner review before use |
| `docs/prompts/calendar-service-context.md` | critical | config_secret_scripts | `docs/playbooks/db-migration-script.md` | block or require controlled owner review before use |
| `docs/prompts/comms-service-context.md` | critical | config_secret_scripts | `docs/playbooks/db-migration-script.md` | block or require controlled owner review before use |
| `docs/prompts/config-service-context.md` | critical | config_secret_scripts | `docs/playbooks/db-migration-script.md` | block or require controlled owner review before use |
| `docs/prompts/data-relay-service-context.md` | critical | config_secret_scripts | `docs/playbooks/db-migration-script.md` | block or require controlled owner review before use |
| `docs/prompts/fix-verified-issues-prompt.md` | critical | config_secret_scripts | `docs/playbooks/db-migration-script.md` | block or require controlled owner review before use |
| `docs/prompts/market-data-service-context.md` | critical | config_secret_scripts | `docs/playbooks/db-migration-script.md` | block or require controlled owner review before use |
| `docs/prompts/marketplace-context.md` | critical | config_secret_scripts | `docs/playbooks/db-migration-script.md` | block or require controlled owner review before use |
| `docs/prompts/message-service-context.md` | critical | config_secret_scripts | `docs/playbooks/db-migration-script.md` | block or require controlled owner review before use |
| `docs/prompts/news-service-context.md` | critical | config_secret_scripts | `docs/playbooks/db-migration-script.md` | block or require controlled owner review before use |
| `docs/prompts/order-service-context.md` | critical | config_secret_scripts | `docs/playbooks/db-migration-script.md` | block or require controlled owner review before use |
| `docs/prompts/payoff-service-context.md` | critical | config_secret_scripts | `docs/playbooks/db-migration-script.md` | block or require controlled owner review before use |
| `docs/prompts/rating-service-context.md` | critical | config_secret_scripts | `docs/playbooks/db-migration-script.md` | block or require controlled owner review before use |
| `docs/prompts/screener-service-context.md` | critical | config_secret_scripts | `docs/playbooks/db-migration-script.md` | block or require controlled owner review before use |
| `docs/prompts/signal-service-context.md` | critical | config_secret_scripts | `docs/playbooks/db-migration-script.md` | block or require controlled owner review before use |
| `docs/prompts/support-service-context.md` | critical | config_secret_scripts | `docs/playbooks/db-migration-script.md` | block or require controlled owner review before use |
| `docs/prompts/system-overview.md` | critical | config_secret_scripts | `docs/playbooks/db-migration-script.md` | block or require controlled owner review before use |
| `docs/prompts/ticker-service-context.md` | critical | config_secret_scripts | `docs/playbooks/db-migration-script.md` | block or require controlled owner review before use |
| `docs/prompts/token-manager-context.md` | critical | config_secret_scripts | `docs/playbooks/db-migration-script.md` | block or require controlled owner review before use |
| `docs/prompts/user-service-context.md` | critical | config_secret_scripts | `docs/playbooks/db-migration-script.md` | block or require controlled owner review before use |
| `docs/prompts/ws-gateway-service-context.md` | critical | config_secret_scripts | `docs/playbooks/db-migration-script.md` | block or require controlled owner review before use |
| `docs/qa/prompts/aef_next_tracks/AEF_306_STRATEGY_SDK_CHANNEL_EXECUTION_HANDOFF_PROMPT.md` | critical | config_secret_scripts | `docs/playbooks/db-migration-script.md` | block or require controlled owner review before use |
| `docs/qa/prompts/aef_next_tracks/AEF_DEFERRED_PRODUCTION_RESILIENCE_READINESS_PROMPT.md` | critical | db_migration_scripts | `docs/playbooks/db-migration-script.md` | block or require controlled owner review before use |
| `docs/qa/prompts/aef_next_tracks/AEF_ORCHESTRATOR_PROMPT.md` | critical | config_secret_scripts | `docs/playbooks/db-migration-script.md` | block or require controlled owner review before use |
| `docs/qa/prompts/aef_next_tracks/AEF_PARALLEL_ENTERPRISE_ARCHITECTURE_REVIEW_PROMPT.md` | critical | db_migration_scripts | `docs/playbooks/db-migration-script.md` | block or require controlled owner review before use |
| `docs/qa/prompts/aef_next_tracks/README.md` | critical | broker_order_scripts | `docs/playbooks/ownerless-high-risk-automation.md` | block or require controlled owner review before use |
| `infra-prompt.txt` | critical | config_secret_scripts | `docs/playbooks/db-migration-script.md` | block or require controlled owner review before use |
...
| `signal_service/AGENTS.md` | critical | config_secret_scripts | `docs/playbooks/ownerless-high-risk-automation.md` | block or require controlled owner review before use |
| `.claude/commands/browser-test.md` | high | db_migration_scripts | `docs/playbooks/db-migration-script.md` | map to canonical automation or document exception |
| `.claude/commands/debug-browser.md` | high | ai_agent_tooling | `docs/playbooks/ownerless-high-risk-automation.md` | map to canonical automation or document exception |
| `.claude/commands/service-context.md` | high | config_secret_scripts | `docs/playbooks/db-migration-script.md` | map to canonical automation or document exception |
| `.claude/commands/update-service-prompt.md` | high | config_secret_scripts | `docs/playbooks/db-migration-script.md` | map to canonical automation or document exception |
...
| `AGENTS.md` | high | broker_order_scripts | `docs/playbooks/ownerless-high-risk-automation.md` | assign owner boundary |
| `BROWSER_DEBUGGING_PROMPT.md` | high | ai_agent_tooling | `docs/playbooks/ownerless-high-risk-automation.md` | map to canonical automation or document exception |
| `PHASE_2.5_DAY3_IMPLEMENTATION_PROMPT.md` | high | db_migration_scripts | `docs/playbooks/db-migration-script.md` | map to canonical automation or document exception |
| `SPRINT_1.5_MARKETPLACE_INFRASTRUCTURE_PROMPT.md` | high | config_secret_scripts | `docs/playbooks/db-migration-script.md` | map to canonical automation or document exception |
| `alert_service/app/background/evaluation_worker.py` | high | config_secret_scripts | `docs/playbooks/db-migration-script.md` | map to canonical automation or document exception |
| `alert_service/test_evaluation.py` | high | config_secret_scripts | `docs/playbooks/db-migration-script.md` | map to canonical automation or document exception |
| `docs/prompts/ADV_ADVISORY_LAYER_IMPLEMENTATION.md` | high | config_secret_scripts | `docs/playbooks/db-migration-script.md` | map to canonical automation or document exception |
| `docs/prompts/API_GATEWAY_ARCHITECTURE.md` | high | config_secret_scripts | `docs/playbooks/db-migration-script.md` | map to canonical automation or document exception |
| `docs/prompts/MESSAGING_SERVICE_SPRINT_PLAN.md` | high | config_secret_scripts | `docs/playbooks/db-migration-script.md` | map to canonical automation or document exception |
| `docs/prompts/MY_STRATEGIES_PAGE_REDESIGN.md` | high | db_migration_scripts | `docs/playbooks/db-migration-script.md` | map to canonical automation or document exception |
| `docs/prompts/algo-engine-advanced-intent-wiring-prompt.md` | high | db_migration_scripts | `docs/playbooks/db-migration-script.md` | map to canonical automation or document exception |
| `docs/prompts/dataflows.md` | high | config_secret_scripts | `docs/playbooks/db-migration-script.md` | map to canonical automation or document exception |
| `docs/prompts/domain-glossary.md` | high | config_secret_scripts | `docs/playbooks/db-migration-script.md` | map to canonical automation or document exception |
| `docs/prompts/new-broker-integration-master-prompt.md` | high | config_secret_scripts | `docs/playbooks/db-migration-script.md` | map to canonical automation or document exception |
| `docs/prompts/technical-writer-context.md` | high | config_secret_scripts | `docs/playbooks/db-migration-script.md` | map to canonical automation or document exception |
| `docs/qa/prompts/aef_next_tracks/AEF_DEFERRED_BROKER_ORDER_WRITE_SAFETY_PROMPT.md` | high | db_migration_scripts | `docs/playbooks/db-migration-script.md` | map to canonical automation or document exception |
| `docs/qa/prompts/aef_next_tracks/AEF_DEFERRED_COMMAND_CENTER_TRADING_DASHBOARD_ALIGNMENT_PROMPT.md` | high | db_migration_scripts | `docs/playbooks/db-migration-script.md` | map to canonical automation or document exception |
| `docs/qa/prompts/aef_next_tracks/AEF_PARALLEL_EXECUTION_METADATA_PROJECTION_REVIEW_PROMPT.md` | high | db_migration_scripts | `docs/playbooks/db-migration-script.md` | map to canonical automation or document exception |
| `docs/qa/prompts/aef_next_tracks/AEF_PARALLEL_GATEWAY_DATA_READ_PROJECTION_REVIEW_PROMPT.md` | high | db_migration_scripts | `docs/playbooks/db-migration-script.md` | map to canonical automation or document exception |
| `docs/qa/prompts/aef_next_tracks/AEF_PARALLEL_SCRIPT_STRATEGY_EXECUTION_REVIEW_PROMPT.md` | high | db_migration_scripts | `docs/playbooks/db-migration-script.md` | map to canonical automation or document exception |
...
| `BACKEND_TEAM_PROMPT_LOGIN_AFTER_SIGNUP.md` | high | db_migration_scripts | `docs/playbooks/db-migration-script.md` | map to canonical automation or document exception |
| `docs/prompts/API_GATEWAY_TESTING_CONTINUATION.md` | high | config_secret_scripts | `docs/playbooks/db-migration-script.md` | map to canonical automation or document exception |
| `docs/prompts/FRONTEND_API_GATEWAY_MIGRATION.md` | high | config_secret_scripts | `docs/playbooks/db-migration-script.md` | map to canonical automation or document exception |
| `docs/qa/prompts/aef_next_tracks/AEF_DEFERRED_RATE_POLICY_RUNTIME_ADMISSION_PROMPT.md` | high | db_migration_scripts | `docs/playbooks/db-migration-script.md` | map to canonical automation or document exception |
| `docs/qa/prompts/aef_next_tracks/AEF_PARALLEL_MANUAL_TRADING_SHARED_FOUNDATION_REVIEW_PROMPT.md` | high | db_migration_scripts | `docs/playbooks/db-migration-script.md` | map to canonical automation or document exception |
| `prompts_for_validation.md` | high | db_migration_scripts | `docs/playbooks/db-migration-script.md` | map to canonical automation or document exception |
