...
class ProductApiTests(unittest.TestCase):
    def test_build_snapshot_contains_stable_sections(self) -> None:
        ...
        self.assertEqual(snapshot["dip"]["deterministic_policy_engine_readiness_percent"], 20.0)
        self.assertEqual(snapshot["dip"]["computed_simulation_diff_readiness_percent"], 10.0)
        self.assertEqual(snapshot["dip"]["durable_case_store_readiness_percent"], 10.0)
        self.assertEqual(snapshot["dip"]["identity_backed_approval_readiness_percent"], 0.0)
        self.assertEqual(snapshot["dip"]["release_management_readiness_percent"], 0.0)
