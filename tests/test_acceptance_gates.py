...
class AcceptanceGatesTests(unittest.TestCase):
    ...
    def test_v2_report_contract_is_satisfied(self) -> None:
        check_v2_report_contract()

    def test_v3_backlog_contract_is_satisfied(self) -> None:
        check_v3_backlog_contract()
    ...
    def test_v5_backlog_contract_is_satisfied(self) -> None:
        check_v5_backlog_contract()

    def test_v5_report_contract_is_satisfied(self) -> None:
        check_v5_report_contract()
